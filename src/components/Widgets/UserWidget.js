...
const UserWidget = () => {
    ...
    return (
      <>
        ...
        <div className="group mx-2 flex items-center">
          <button className="outline-none focus:outline-none hover:text-red-600">
          ...
          >
            <li className="rounded-sm hover:bg-gray-100 cursor-pointer hover:text-red-600">
              <Link className="block p-1 " to="/mi-cuenta">
                Configurar
              </Link>
            </li>
            <li className="rounded-sm py-1 hover:bg-gray-100 cursor-pointer hover:text-red-600">
              <Link className="block p-1" to="/mi-cuenta/pedidos">
                Mis pedidos
              </Link>
            </li>
            <li
              className="rounded-sm  p-1 hover:bg-gray-100 cursor-pointer hover:text-red-600"
  ...
  return (
    <div className="flex mx-2 lg:w-2/5 items-center justify-end pb-1">
      <Link to="/login" className="flex items-center hover:text-red-600">
        <FontAwesomeIcon icon={faUserAlt}></FontAwesomeIcon>
      </Link>
    </div>
  );
